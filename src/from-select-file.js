    ...
    return (
        <div className ="mt-4 mx-auto p-3 rounded" style={{width:'400px',background:'#cee'}}>
            ...
            <div className="form-group mb-3">
                ...
                <select id="maxNumFiles" className = "form-select from-select-sm" ref={selectMaxNumFiles}>
                    {
                        maxNumfiles.map (i =>{
                    ...
                    <div className="form-group mb-3">
                        ...
                        <select id="maxFileSize" className="form-select from-select-sm"ref={selectMaxSize}>
                        {
                            maxSize.map (i=>{
                                return <option value={i}>{i}</option>
                            })
